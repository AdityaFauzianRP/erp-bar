<x-filament-panels::page>
    ...
    <div x-data="{
        ...
        openPrint() {
            ...
            const url = `/proforma-invoices/${this.state.id}/print`;
            ...
            const timeout = setTimeout(() => {
                try {
                    ...
                    console.error('Fallback print gagal:', e);
                }
            }, 5000);
            ...
            frame.onload = () => {
                ...
                try {
                    ...
                    console.error('Gagal memanggil print dari iframe:', e);
                }
            };
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
            ...
            <button :disabled="isApproved()" type="button" class="btn-add" @click="addItem()">+ Tambah Produk</button>
        </div>
                ...
                <tbody>
                    <template x-for="(item, index) in state.items" :key="index">
                        <tr>
                            ...
                            <td>
                                <button :disabled="isApproved()" type="button" @click="removeItem(index)"
        ...
        <div style="margin-top: 24px; display: flex; justify-content: end; align-items: center;">
            <div style="display: flex; gap: 12px; align-items: center;">
                ...
                @can('ApprovePI')
                    <button x-show="!isApproved()" type="button" @click="showApproveModal = true"
                        style="background-color: #3b82f6; color: white; padding: 14px 32px; border: none; border-radius: 10px; font-weight: 700; cursor: pointer; transition: all 0.2s;">
                        ✅ APPROVE SEKARANG
                    </button>
                @endcan
                ...
                <button :disabled="isApproved()" type="button" @click="saveProformaInvoice()" class="btn-save"
                    :disabled="isLoading">
